<!-- Footer Start -->
<footer class="footer-section" style="background: url(images/bg/call-to-action.png);
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <ul class="social-icon margin-bottom-30">
                    ...
                    <li><a href="#" target="_blank" class="google-plus"><i
                            class="icon-social-google"></i></a></li>
                    <li><a href="#" target="_blank" class="instagram"><i
                            class="icon-social-instagram"></i></a></li>
                    <li><a href="#" target="_blank" class="dribbble"><i
                            class="icon-social-dribbble"></i></a></li>
                </ul>
            </div>
            <div class="col-md-12 uipasta-credit"></div>
        </div>
    </div>
</footer>
<!-- Footer End -->
